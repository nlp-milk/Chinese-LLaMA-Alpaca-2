...
with gr.Blocks() as demo:
    github_banner_path = 'https://raw.githubusercontent.com/nlp-milk/Chinese-LLaMA-Alpaca-2/main/pics/banner1.png'
    gr.HTML(f'<p align="center"><a href="https://github.com/nlp-milk/Chinese-LLaMA-Alpaca-2"><img src={github_banner_path} width="700"/></a></p>')
    chatbot = gr.Chatbot()
    with gr.Row():
